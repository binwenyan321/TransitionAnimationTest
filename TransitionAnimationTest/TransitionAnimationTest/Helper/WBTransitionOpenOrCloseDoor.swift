//
//  WBTransitionOpenOrCloseDoor.swift
...
enum WBTransitionOpenOrCloseDoorType {
    case push
    case pop
}

class WBTransitionOpenOrCloseDoor: NSObject {
    
    // MARK: - Public Property
    var type: WBTransitionOpenOrCloseDoorType = .push
    
    // MARK: - Override
    deinit {
        NSLog("WBTransitionOpenOrCloseDoor dealloc")
    }
}

// MARK: Private Method
extension WBTransitionOpenOrCloseDoor {
    /// present动效
...
extension WBTransitionOpenOrCloseDoor: UIViewControllerAnimatedTransitioning {
    /// 返回动画时长
